...
namespace FronkonGames.SpiceUp.Blurry.Editor
{
  ...
  public sealed class SupportWindow : EditorWindow
  {
    ...
    [MenuItem("Help/Fronkon Games/Spice Up/Blurry/Online documentation")]
    public static void OnlineDocumentation() => Application.OpenURL(Constants.Support.Documentation);

    [MenuItem("Help/Fronkon Games/Spice Up/Blurry/Leave a review ❤️")]
    public static void LeaveAReview() => Application.OpenURL(Constants.Support.Store);

    [MenuItem("Help/Fronkon Games/Spice Up/Blurry/Support && suggestions")]
