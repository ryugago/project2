...
namespace FronkonGames.SpiceUp.Blurry
{
  ...
  {
    private static Blurry renderFeature;
    ...
    public static void AddRenderFeature()
    {
      if (IsInRenderFeatures() == false)
      {
        ...
        if (pipelineAsset != null)
        {
          ...
          renderFeature = (Blurry)CreateInstance(typeof(Blurry).ToString());
      ...
      get
      {
        if (renderFeature == null)
        {
          ...
          if (pipelineAsset != null)
          {
            ...
            {
              if (scriptableRendererData.rendererFeatures[i] is Blurry)
                renderFeature = scriptableRendererData.rendererFeatures[i] as Blurry;
            }
          }
        }
