...
namespace FronkonGames.SpiceUp.Rain
{
  ...
  public sealed class SupportWindow : EditorWindow
  {
    ...
    [MenuItem("Help/Fronkon Games/Spice Up/Rain/Online documentation")]
    public static void OnlineDocumentation() => Application.OpenURL(Constants.Support.Documentation);

    [MenuItem("Help/Fronkon Games/Spice Up/Rain/Leave a review ❤️")]
    public static void LeaveAReview() => Application.OpenURL(Constants.Support.Store);

    [MenuItem("Help/Fronkon Games/Spice Up/Rain/Support && suggestions")]
