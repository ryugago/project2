...
namespace FronkonGames.SpiceUp.Rain
{
  ...
  {
    private static Rain renderFeature;
    ...
    public static void AddRenderFeature()
    {
      if (IsInRenderFeatures() == false)
      {
        ...
        if (pipelineAsset != null)
        {
          ...
          renderFeature = (Rain)CreateInstance(typeof(Rain).ToString());
      ...
      get
      {
        if (renderFeature == null)
        {
          ...
          if (pipelineAsset != null)
          {
            ...
            {
              if (scriptableRendererData.rendererFeatures[i] is Rain)
                renderFeature = scriptableRendererData.rendererFeatures[i] as Rain;
            }
          }
        }
