...
namespace FronkonGames.SpiceUp.DoubleVision
{
  ...
  {
    private static DoubleVision renderFeature;
    ...
    public static void AddRenderFeature()
    {
      if (IsInRenderFeatures() == false)
      {
        ...
        if (pipelineAsset != null)
        {
          ...
          renderFeature = (DoubleVision)CreateInstance(typeof(DoubleVision).ToString());
      ...
      get
      {
        if (renderFeature == null)
        {
          ...
          if (pipelineAsset != null)
          {
            ...
            {
              if (scriptableRendererData.rendererFeatures[i] is DoubleVision)
                renderFeature = scriptableRendererData.rendererFeatures[i] as DoubleVision;
            }
          }
        }
