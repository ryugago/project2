...
namespace FronkonGames.SpiceUp.DoubleVision.Editor
{
  ...
  public sealed class SupportWindow : EditorWindow
  {
    ...
    [MenuItem("Help/Fronkon Games/Spice Up/Double Vision/Online documentation")]
    public static void OnlineDocumentation() => Application.OpenURL(Constants.Support.Documentation);

    [MenuItem("Help/Fronkon Games/Spice Up/Double Vision/Leave a review ❤️")]
    public static void LeaveAReview() => Application.OpenURL(Constants.Support.Store);
    
    [MenuItem("Help/Fronkon Games/Spice Up/Double Vision/Support && suggestions")]
